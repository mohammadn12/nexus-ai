...
# --- 🔮 CRASH-FREE PREMIUM ADMIN ROUTES ---
...
def admin_dashboard():
    ...
    # SAFE SUBMIT: Form se naya tool add karne ke liye standard function use karein
    if request.method == 'POST':
        form_data = {
    ...
    # Beautiful Dark Theme UI with Form and Counter
    html = f'''
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>NexusAI - Admin Panel</title>
        <style>
    ...
    <body>
        <div class="navbar">
            <h2>🔮 NexusAI Admin Panel</h2>
            <a href="/secret-admin/logout" class="logout-btn">Logout</a>
        </div>
        <div class="container">
            <!-- LEFT PANEL: Stats & Add Tool Form -->
            <div>
                ...
                <div class="panel-card">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="website_url" class="form-control" placeholder="https://..." required>
